    ...
    ?>
           <div class="container">
            ...
            <div class="leftinnerdiv">
                ...
                <Button class="greenbtn" onclick="openpart('mydetail')"> My Details</Button>
            ...
            <div id="mydetail" class="innerright portion" style="<?php  if(!empty($_REQUEST['returnid'])){ echo "display:none";} else {echo ""; }?>">
            <Button class="greenbtn" >My Details</Button>
