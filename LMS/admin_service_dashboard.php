...
elseif($msg=="fail"){
    ...
    ?>
        ...
        <div class="container">
        <div class="innerdiv">
            <div class="row"><img class="imglogo" src="logo.png"/></div>
            ...
            <div>Branch:<input type="radio" name="branch" value="other"/>other<input type="radio" name="branch" value="CSE"/>CSE<div style="margin-left:80px"><input type="radio" name="branch" value="Mathemathics"/>Mathematics<input type="radio" name="branch" value="ECE"/>ECE</div>
            </div>   
